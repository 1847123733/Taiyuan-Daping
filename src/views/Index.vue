  ...
  <div class="page-wrapper">
    ...
    <div class="wrapper">
      ...
      <div class="data3-wrapper">
        ...
        <div class="video">
          <span style="color: aqua;font-size: 30px">视频监控</span>
          <span style="color: white;position: absolute;right: 15px;font-size: 30px">太原交警</span>
          <div class="videos" v-if="hidden">
            <div class="act-form">
              <iframe
                scrolling="auto"
                class="frame"
                frameborder="0"
                src="./static/demoss.html"
              ></iframe>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  import taiyuan from './img/taiyuan'
