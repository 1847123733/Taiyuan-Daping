<template>
  <div>
    ...
    <el-table
      ...
      <el-table-column prop="description" label="日志描述" width="180" align="center"></el-table-column>
      <el-table-column prop="actionmethod" label="访问方法" align="center" width="100"></el-table-column>
