...
$(function () {
	...
	// 初始化插件参数及插入插件
	WebVideoCtrl.I_InitPlugin('100%', 580, {
		iWndowType: 2,
	...
	$("#endtime").val(szCurTime + " 00:01:59");
});
// 显示操作信息
...
var int = self.setTimeout(function() {
  // 这个方法是说在延迟两秒后执行大括号里的方法
  clickLogin(); // 这个方法是刷新当前页面
}, 2000); //这里2000代表两秒
